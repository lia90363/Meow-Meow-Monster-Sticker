...
### 📸 專案預覽  
<img width="2610" height="1466" alt="image" src="https://github.com/user-attachments/assets/f681546c-1713-44ad-a3f8-0aa0197f30a8" />  
左側為首頁+手機單欄+白天模式  
中間為最愛+手機雙欄+夜間模式  
右側為詳情(最近瀏覽)  
...
- LocalStorage（Persist）：保存使用者收藏、歷史紀錄、單/雙欄、日夜模式  
